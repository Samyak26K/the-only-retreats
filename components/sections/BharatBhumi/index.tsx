    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to right, rgba(245,237,216,0.92) 0%, rgba(245,237,216,0.75) 30%, rgba(245,237,216,0.2) 55%, transparent 75%)",
          }}
        />

        <div className="absolute inset-0 z-[2] flex items-center">
          <div className="max-w-xs px-6 py-12 md:max-w-sm md:px-12 lg:max-w-md lg:px-16 xl:px-20">
            <p
            ...
            <h2
              className="font-sanskrit mb-1 text-4xl leading-tight md:text-5xl lg:text-6xl"
              style={{ color: "#2C1A0E" }}
            >
              भारतभूमि
            </h2>
            ...
            <p
              className="font-heading mb-5 text-xl font-semibold uppercase tracking-[0.1em] md:text-2xl"
              style={{ color: "#2C1A0E" }}
            >
              Bharat Bhumi
            </p>
            ...
            <p
              className="font-body text-xs leading-6 md:text-sm md:leading-7"
              style={{ color: "#5A3A1A" }}
            >
